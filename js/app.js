                ...
                2: [ function(require, module, exports) {
                    ...
                    var GreenAudioPlayer = function() {
                        function GreenAudioPlayer(player, options) {
                            ...
                            this.audioPlayer = "string" === typeof player ? document.querySelector(player) : player;
                            var opts = options || {};
                            ...
                            if (!this.enableKeystrokes) for (var i = 0; i < this.span.length; i++) this.span[i].outerHTML = ""; else {
                            ...
                            if (opts.showDownloadButton || false) this.showDownload();
                            this.initEvents();
                            this.directionAware();
                            this.overcomeIosLimitations();
                            if ("autoplay" in this.player.attributes) {
                                var promise = this.player.play();
                                if (void 0 !== promise) promise.then((function() {
                            ...
                            if ("preload" in this.player.attributes && "none" === this.player.attributes.preload.value) {
                        ...
                        _createClass(GreenAudioPlayer, [ {
                                ...
                                self.audioPlayer.addEventListener("mousedown", (function(event) {
                                    if (self.isDraggable(event.target)) {
                                        ...
                                        if (self.currentlyDragged.parentElement.parentElement === self.sliders[0]) {
                                            ...
                                            if (false === self.paused) self.togglePlay();
                                        }
                                        window.addEventListener("mouseup", (function() {
                                            if (false !== self.currentlyDragged && self.currentlyDragged.parentElement.parentElement === self.sliders[0] && self.paused !== self.player.paused) self.togglePlay();
                            ...
                            value: function isDraggable(el) {
                                var canDrag = false;
                                if ("undefined" === typeof el.classList) return false;
                                for (var i = 0; i < this.draggableClasses.length; i++) if (el.classList.contains(this.draggableClasses[i])) canDrag = true;
                                return canDrag;
                            }
                        }, {
                            key: "inRange",
                            ...
                            value: function updateVolume() {
                                ...
                                if (this.player.volume >= .5) this.speaker.attributes.d.value = "M14.667 0v2.747c3.853 1.146 6.666 4.72 6.666 8.946 0 4.227-2.813 7.787-6.666 8.934v2.76C20 22.173 24 17.4 24 11.693 24 5.987 20 1.213 14.667 0zM18 11.693c0-2.36-1.333-4.386-3.333-5.373v10.707c2-.947 3.333-2.987 3.333-5.334zm-18-4v8h5.333L12 22.36V1.027L5.333 7.693H0z"; else if (this.player.volume < .5 && this.player.volume > .05) this.speaker.attributes.d.value = "M0 7.667v8h5.333L12 22.333V1L5.333 7.667M17.333 11.373C17.333 9.013 16 6.987 14 6v10.707c2-.947 3.333-2.987 3.333-5.334z"; else if (this.player.volume <= .05) this.speaker.attributes.d.value = "M0 7.667v8h5.333L12 22.333V1L5.333 7.667";
                            }
                        }, {
                            key: "getRangeBox",
                            value: function getRangeBox(event) {
                                ...
                                if ("click" === event.type && this.isDraggable(event.target)) rangeBox = event.target.parentElement.parentElement;
                                if ("mousemove" === event.type) rangeBox = el.parentElement.parentElement;
                                if ("touchmove" === event.type) rangeBox = el.target.parentElement.parentElement;
                                return rangeBox;
                            }
                        }, {
                            key: "getCoefficient",
                            value: function getCoefficient(event) {
                                ...
                                var K = 0;
                                if ("horizontal" === slider.dataset.direction) {
                                    var clientX = touch ? event.touches[0].clientX : event.clientX;
                                    var offsetX = clientX - sliderPositionAndDimensions.left;
                                    var width = sliderPositionAndDimensions.width;
                                    K = offsetX / width;
                                } else if ("vertical" === slider.dataset.direction) {
                            ...
                            value: function rewind(event) {
                                if (this.player.seekable && this.player.seekable.length) if (this.inRange(event)) this.player.currentTime = this.player.duration * this.getCoefficient(event);
                            }
                        }, {
                            key: "showVolume",
                            ...
                            value: function changeVolume(event) {
                                if (this.inRange(event)) this.player.volume = Math.round(50 * this.getCoefficient(event)) / 50;
                            }
                        }, {
                            key: "preloadNone",
                            ...
                            value: function togglePlay() {
                                ...
                                if (this.player.paused) {
                                    if (this.stopOthersOnPlay) GreenAudioPlayer.stopOtherPlayers();
                            ...
                            value: function hasSetAttribute(el, a, v) {
                                if (this.showTooltips) if (el.hasAttribute(a)) el.setAttribute(a, v);
                            }
                        }, {
                            key: "setCurrentTime",
                            value: function setCurrentTime(time) {
                                ...
                                if (pos + time < 0 && 0 === pos) this.player.currentTime = this.player.currentTime; else if (pos + time < 0) this.player.currentTime = 0; else if (pos + time > end) this.player.currentTime = end; else this.player.currentTime += time;
                            }
                        }, {
                            key: "setVolume",
                            value: function setVolume(volume) {
                                ...
                                if (vol + volume >= 0 && vol + volume < 1) this.player.volume += volume; else if (vol + volume <= 0) this.player.volume = 0; else this.player.volume = 1;
                            }
                        }, {
                            key: "unPressKb",
                            value: function unPressKb(event) {
                                var evt = event || window.event;
                                if (this.seeking && (37 === evt.keyCode || 39 === evt.keyCode)) {
                                    this.togglePlay();
                                    this.seeking = false;
                                }
                            }
                            ...
                            value: function pressKb(event) {
                                ...
                                switch (evt.keyCode) {
                                  ...
                                  case 32:
                                    ...
                                    if (13 === evt.keyCode && this.showDownload && document.activeElement.parentNode === this.downloadLink) this.downloadLink.focus();
                                    break;

                                  case 37:
                                  case 39:
                                    if (document.activeElement === this.sliders[0]) {
                                        if (37 === evt.keyCode) this.setCurrentTime(-5); else this.setCurrentTime(+5);
                                  ...
                                  case 38:
                                  case 40:
                                    if (document.activeElement.parentNode === this.volumeBtn || document.activeElement === this.sliders[1]) if (38 === evt.keyCode) this.setVolume(.05); else this.setVolume(-.05);
                            ...
                            value: function directionAware() {
                                ...
                                if (window.innerHeight < 250) this.volumeControls.classList.add("middle"); else if (this.audioPlayer.getBoundingClientRect().top < 180) this.volumeControls.classList.add("bottom"); else this.volumeControls.classList.add("top");
                            }
                        } ], [ {
                            key: "init",
                            ...
                            value: function stopOtherPlayers() {
                                ...
                                for (var i = 0; i < players.length; i++) GreenAudioPlayer.pausePlayer(players[i]);
                            }
                        } ]);
